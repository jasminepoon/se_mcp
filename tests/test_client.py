...
class TestStreeteasyMcp:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: StreeteasyMcp) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: StreeteasyMcp) -> None:
    ...
    def test_copy(self, client: StreeteasyMcp) -> None:
        copied = client.copy()
        assert id(copied) != id(client)

        copied = client.copy(rapidapi_key="another My Rapidapi Key")
        assert copied.rapidapi_key == "another My Rapidapi Key"
        assert client.rapidapi_key == "My Rapidapi Key"

    def test_copy_default_options(self, client: StreeteasyMcp) -> None:
    ...
    def test_copy_signature(self, client: StreeteasyMcp) -> None:
    ...
    def test_copy_build_request(self, client: StreeteasyMcp) -> None:
    ...
    def test_request_timeout(self, client: StreeteasyMcp) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_request_extra_json(self, client: StreeteasyMcp) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: StreeteasyMcp) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: StreeteasyMcp) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: StreeteasyMcp) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: StreeteasyMcp) -> None:
    ...
    def test_non_application_json_content_type_for_json_data(
        self, respx_mock: MockRouter, client: StreeteasyMcp
    ) -> None:
        """
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = StreeteasyMcp(base_url=base_url, rapidapi_key=rapidapi_key, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: StreeteasyMcp) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        non_strict_client = StreeteasyMcp(
            base_url=base_url, rapidapi_key=rapidapi_key, _strict_response_validation=False
        )
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: StreeteasyMcp
    ) -> None:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: StreeteasyMcp) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.rentals.with_streaming_response.search(areas="all-downtown,all-midtown").__enter__()
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/rentals/search").mock(side_effect=retry_handler)

        response = client.rentals.with_raw_response.search(areas="all-downtown,all-midtown")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.rentals.with_raw_response.search(
            areas="all-downtown,all-midtown", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.rentals.with_raw_response.search(
            areas="all-downtown,all-midtown", extra_headers={"x-stainless-retry-count": "42"}
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: StreeteasyMcp) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: StreeteasyMcp) -> None:
...
class TestAsyncStreeteasyMcp:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncStreeteasyMcp) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncStreeteasyMcp) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncStreeteasyMcp) -> None:
        copied = async_client.copy()
        assert id(copied) != id(async_client)

        copied = async_client.copy(rapidapi_key="another My Rapidapi Key")
        assert copied.rapidapi_key == "another My Rapidapi Key"
        assert async_client.rapidapi_key == "My Rapidapi Key"

    def test_copy_default_options(self, async_client: AsyncStreeteasyMcp) -> None:
        # options that have a default are overridden correctly
    ...
    def test_copy_signature(self, async_client: AsyncStreeteasyMcp) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncStreeteasyMcp) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncStreeteasyMcp) -> None:
    ...
    async def test_default_headers_option(self) -> None:
        test_client = AsyncStreeteasyMcp(
            base_url=base_url,
            rapidapi_key=rapidapi_key,
            _strict_response_validation=True,
            default_headers={"X-Foo": "bar"},
        ...
        test_client2 = AsyncStreeteasyMcp(
            base_url=base_url,
            rapidapi_key=rapidapi_key,
            _strict_response_validation=True,
            default_headers={
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncStreeteasyMcp) -> None:
        class Model1(BaseModel):
            name: str
    ...
    async def test_base_url_trailing_slash(self, client: AsyncStreeteasyMcp) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncStreeteasyMcp) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncStreeteasyMcp) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncStreeteasyMcp(base_url=base_url, rapidapi_key=rapidapi_key, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        non_strict_client = AsyncStreeteasyMcp(
            base_url=base_url, rapidapi_key=rapidapi_key, _strict_response_validation=False
        )
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncStreeteasyMcp
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.rentals.with_streaming_response.search(areas="all-downtown,all-midtown").__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.rentals.with_raw_response.search(areas="all-downtown,all-midtown")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.rentals.with_raw_response.search(
            areas="all-downtown,all-midtown", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncStreeteasyMcp) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncStreeteasyMcp) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
