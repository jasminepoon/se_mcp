...
class RentalsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> RentalsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/se-mcp-2-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> RentalsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/se-mcp-2-python#with_streaming_response
        """
